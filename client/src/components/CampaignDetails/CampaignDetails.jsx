...
//   const [savedCampaigns, setSavedCampaigns] = useState(JSON.parse(localStorage.getItem("savedCampaigns")) || {}
//   );

//   useEffect(() => {
//     const localStorageValue = localStorage.getItem("savedCampaigns");
//     if (localStorageValue) {
//       setSavedCampaigns(JSON.parse(localStorageValue));
//     }
//   }, []);
